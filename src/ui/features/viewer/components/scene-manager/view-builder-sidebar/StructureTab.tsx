...
export function StructureTab({
    ...
    // Force active ID to the selected tab OR the first available component
    const activeComponentId =
        currentComponentId &&
        viewModel.components.some((c) => c.id === currentComponentId)
            ? currentComponentId
            ...
            <Collapse expanded={componentsSectionExpanded}>
                <AssetBuilderCardSectionGroup divider={false}>
                    ...
                    <CollapseTrigger
                        ...
                        onClick={() => {
                            setComponentFocusSectionExpanded((prev) => {
                                const nextState = !prev;
                                if (activeComponentId) {
                    ...
                    <Collapse expanded={componentFocusSectionExpanded}>
                        <AssetBuilderCardSectionGroup>
                            <Checkbox
                                label="Show focus"
                                size="xs"
                                checked={currentComponent?.show_focus ?? false}
                                onChange={(e) => {
                                    if (activeComponentId)
                                        onUpdateStructureComponentParam(
                                            activeComponentId,
                            ...
                            />
                            <FocusControls
                                enable={currentComponent?.show_focus ?? false}
